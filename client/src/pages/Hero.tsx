...
export const HomeHero: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden items-center gap-2 sm:flex">
                ...
                <button className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-700/80 bg-slate-900/80 text-[11px] font-medium text-slate-200 shadow-sm shadow-slate-900/60">
                  {/* Simple initial/avatar placeholder */}
                  Y
                </button>
              </div>
            </div>
      ...
      {/* Hero */}
      <main className="mx-auto flex max-w-6xl flex-col items-center px-4 pb-16 pt-10 sm:px-6 sm:pt-16 lg:px-8 lg:pt-20">
        {/* Soft radial light */}
        <div
          aria-hidden="true"
        ...
        <section className="w-full max-w-3xl text-center">
          ...
          <div className="mt-8 rounded-2xl border border-slate-800/90 bg-slate-900/70 p-4 shadow-xl shadow-slate-950/60 sm:p-5">
            ...
            <div className="mt-3 flex items-center justify-center">
              <button className="inline-flex items-center gap-1 text-xs font-medium text-slate-400 transition-colors hover:text-slate-100">
