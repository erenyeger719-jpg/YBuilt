            ...
            <form onSubmit={handleCreate}>
              ...
              <div className="flex h-[96px] flex-col justify-between rounded-[24px] bg-[#292929] px-8 py-4 sm:px-10 sm:py-4">
                ...
                <div className="flex items-center justify-between mt-3.5">
                  {/* Left cluster: + and Attach - shifted left by 6 spaces */}
                  <div className="relative flex items-center gap-2 -ml-3">
                    {/* Plus icon – matching the good design */}
                    <button
                      type="button"
                    ...
                    {isPlusMenuOpen && (
                      <div
                        ref={plusMenuRef}
                        className="absolute left-0 bottom-full mb-2 z-20 w-72 overflow-hidden rounded-2xl border border-white/12 bg-[#101010] py-1 shadow-xl shadow-black/70 backdrop-blur"
                      >
                        {/* Take a screenshot */}
                        <button
                          type="button"
                    ...
                    {/* Attach pill — styled to match the good design */}
                    <button
                      type="button"
                  ...
                  {/* Right cluster: Mic + Send - shifted right by 6 spaces */}
                  <div className="flex items-center gap-2.5 -mr-3">
                    {/* Mic button – matching good design */}
                    <button
                      type="button"
                    ...
                    {/* Send button - grey when empty, white when text present */}
                    <button
                      type="submit"
